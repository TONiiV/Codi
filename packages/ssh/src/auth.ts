...
# Invoked by ssh via SSH_ASKPASS when Codi re-runs ssh with a cached password
...
printf 'Codi ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when Codi re-runs\r
...
[Console]::Error.WriteLine("Codi ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
