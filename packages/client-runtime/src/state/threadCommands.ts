...
import {
  ...
  type DismissThreadUsageLimitInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    dismissUsageLimit: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dismiss-usage-limit",
      execute: (input: DismissThreadUsageLimitInput) => dismissThreadUsageLimit(input),
      scheduler,
      concurrency,
    }),
