...
/**
 * The palette Codi wears with no theme installed, captured from the app's
...
/**
 * The standard Codi look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Codi shows without a theme, read from the app's own
