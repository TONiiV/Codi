...
function getGnomeKeyringRemediationMessage(): string {
  return "Codi could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Codi.";
}

function getKWalletRemediationMessage(): string {
  return "Codi could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Codi.";
}
