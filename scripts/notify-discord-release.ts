  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Codi prerelease is available for nightly testers."
          : "A new Codi latest release is available.",
...
).pipe(Command.withDescription("Post a Codi release announcement to Discord."));
