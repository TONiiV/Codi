...
> For maintainers. Using Codi? See [docs/user](../user/).

This is a living glossary for Codi. It explains what common terms mean in this codebase.
...
ships Codi already matching it.
