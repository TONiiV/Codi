...
T3CODE_PORT=13773 \
  "/Applications/Codi (Alpha).app/Contents/MacOS/Codi (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Codi (Alpha).app"
codesign -d --entitlements :- "/Applications/Codi (Alpha).app"
```
